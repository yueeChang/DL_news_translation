...
BATCH_SIZE = 15  # translate 15 pieces of news at one time

def translate_batch_deepl(texts, source_lang="EN", target_lang="DE"):
    """
...
# file paths
input_file = "C:/Users/DELL/Desktop/folderforall/本科毕业论文/DL_news_translation/data_expansion/WMT_enzh.json"
...
for i in range(0, len(text_list), BATCH_SIZE):
    ...
    translated_texts = translate_batch_deepl(batch_texts, "EN", "DE")
    
    for j, translated in enumerate(translated_texts):
        data[batch_indices[j]]["DE"] = translated
